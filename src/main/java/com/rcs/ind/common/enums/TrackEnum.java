...
public enum TrackEnum {
	...
	NationalitySyErValid("com.rcs.ind.track.nationality.sy.er.valid", "3. Nationaliteit (Syrische of Eritreese) (Id-documenten aangeleverd)"),
	NationalityElse("com.rcs.ind.track.nationality.else", "4. Overige Nationaliteiten"),
	NationalitySyErInvalid("com.rcs.ind.track.nationality.sy.er.invalid", "5. Nationaliteit (Syrische of Eritreese) (Geen id-documenten aangeleverd)"),
	;
